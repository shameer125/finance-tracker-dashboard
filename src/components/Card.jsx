...
export default function Card({
  ...
  return (
    <div
      className={`glass-card p-6 rounded-3xl relative overflow-hidden flex flex-col 
    justify-between min-h-[140px]`}
    >
      {/* Light glow pattern inside cards */}
      <div
        className="absolute -top-10 -right-10 w-24 h-24 bg-indigo-500/5 rounded-full 
      ...
      <div>
        ...
        {trend && (
          <div className="flex items-center gap-1.5 mt-2">
            <span
              className={`inline-flex items-center p-0.5 rounded-md text-xs font-semibold ${
                trendType === "positive"
